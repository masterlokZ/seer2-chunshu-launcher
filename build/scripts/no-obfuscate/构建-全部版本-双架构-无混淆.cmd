...
echo [构建-全部版本-双架构-无混淆] 开始 @ %TS%
echo [构建-全部版本-双架构-无混淆] 清理对应 mode 输出
call "%~dp0..\helpers\clean-mode.cmd" 0
if errorlevel 1 exit /b 9

echo.
echo [构建-全部版本-双架构-无混淆] 步骤 1/4: 背景版 x64
call "%~dp0..\helpers\build-core.cmd" background x64 0
if errorlevel 1 exit /b 11

echo.
echo [构建-全部版本-双架构-无混淆] 步骤 2/4: 背景版 x32
call "%~dp0..\helpers\build-core.cmd" background ia32 0
if errorlevel 1 exit /b 12

echo.
echo [构建-全部版本-双架构-无混淆] 步骤 3/4: 无背景版 x64
call "%~dp0..\helpers\build-core.cmd" normal x64 0
if errorlevel 1 exit /b 13

echo.
echo [构建-全部版本-双架构-无混淆] 步骤 4/4: 无背景版 x32
...
echo.
echo [构建-全部版本-双架构-无混淆] =======================================================
echo [构建-全部版本-双架构-无混淆] 全部 4 个无混淆产物已就绪
echo [构建-全部版本-双架构-无混淆] =======================================================
exit /b 0
